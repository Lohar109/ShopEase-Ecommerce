  ...
  <>
    ...
    <div className="featured-products-grid">
      <div className="product-card">
        <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=600&auto=format&fit=crop" alt="High-quality wireless headphones" className="product-image" />
      ...
      <div className="product-card">
        <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop" alt="Sleek smart watch" className="product-image" />
        <h3 className="product-title">Smart Watch</h3>
        <span className="product-price">$129.99</span>
        <button type="button" className="btn-buy-now">Buy Now</button>
      </div>
      <div className="product-card">
        <img src="https://images.unsplash.com/photo-1608156639585-b3a032ef9689?q=80&w=600&auto=format&fit=crop" alt="Portable bluetooth speaker" className="product-image" />

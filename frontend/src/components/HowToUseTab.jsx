  ...
  return (
    <div className="pdp-tab-content pdp-specs-tab-premium py-8 pt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-10">
        ...
        <div className="md:col-span-7 min-w-0 w-full bg-gray-50 rounded-2xl flex items-center justify-center overflow-hidden p-0" style={{ height: '366px' }}>
          {hero_image_url ? (
            <img
              src={hero_image_url}
            ...
            return (
              <div key={idx} className="pdp-inclusions-card">
                <div>
                  ...
                  {stepDesc && <p className="pdp-inclusions-subtitle">{stepDesc}</p>}
                </div>
